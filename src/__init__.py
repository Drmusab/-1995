"""
AI Assistant - Advanced AI Assistant with multimodal processing, workflow
orchestration, and extensible plugin system.

This package provides a comprehensive AI assistant framework with the following
core capabilities:
