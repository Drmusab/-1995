...
class DatabaseConfiguration:
    ...
    database_url: str = os.getenv('DATABASE_URL', 'postgresql://user:pass@localhost:5432/assistant_prod')
    ...
    # Read replicas
    read_replica_urls: List[str] = field(default_factory=lambda: [
...
class MonitoringConfiguration:
    ...
    critical_alert_channels: List[str] = field(default_factory=lambda: ['slack', 'email', 'pagerduty'])
...
class BackupConfiguration:
    ...
    backup_directories: List[str] = field(default_factory=lambda: [
        '/data/models',
        '/data/user_data',
        '/data/knowledge_base',
        '/configs'
